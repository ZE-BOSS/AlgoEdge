...
async def init_db():
    ...
    async with engine.begin() as conn:
        ...
        migrations = [
            ...
            "ALTER TABLE users ADD COLUMN deriv_mt5_account BIGINT;",
            "ALTER TABLE users ADD COLUMN deriv_mt5_password_encrypted BLOB;",
            "ALTER TABLE users ADD COLUMN deriv_mt5_server VARCHAR(100);",
            "ALTER TABLE users ADD COLUMN deriv_mt5_path VARCHAR(500);",
            "ALTER TABLE backtest_runs ADD COLUMN title VARCHAR(100);",
