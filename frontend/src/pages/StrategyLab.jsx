...
const STRATEGIES = [
  ...
  { id: 'SpikeFade_v1', group: 'synth', label: 'Spike fade' },
  { id: 'RangeRevert_v1', group: 'synth', label: 'Range revert' },
  { id: 'RangeBreakout_v1', group: 'synth', label: 'Range breakout' },
  { id: 'TrendDrift_v1', group: 'synth', label: 'Trend drift' },
];
